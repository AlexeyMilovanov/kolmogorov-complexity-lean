...
lemma splitNode_computable :
  ...
  · convert Primrec.list_append.comp Primrec.fst
      (Primrec.comp replicate_false_primrec
        (Primrec.comp Primrec.nat_sub
          (Primrec.snd.pair (Primrec.comp Primrec.list_length Primrec.fst)))) using 1;
  · convert Primrec.list_map _ _ using 1;
    all_goals try infer_instance;
    · convert Primrec.list_range.comp
        (Primrec.nat_sub.comp Primrec.snd (Primrec.list_length.comp Primrec.fst)) using 1;
    · convert Primrec₂.comp _ _ _ using 1;
      all_goals try infer_instance;
      · exact Primrec.list_append
      · convert Primrec.list_append.comp (Primrec.fst.comp Primrec.fst)
          (replicate_false_primrec.comp Primrec.snd) using 1;
