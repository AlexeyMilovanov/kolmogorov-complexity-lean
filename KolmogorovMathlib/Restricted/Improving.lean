...
def familyStageModelCodesList_hg_arg (q : ℕ × ℕ × ℕ) : ℕ × ℕ × ℕ :=
  (q.1, q.2.1, 0)

theorem familyStageModelCodesList_hg_arg_comp : Computable familyStageModelCodesList_hg_arg :=
...
def familyStageModelCodesList_happ_arg (r : (ℕ × ℕ × ℕ) × (ℕ × List BitString)) : ℕ × ℕ × ℕ :=
  (r.1.1, r.1.2.1, r.2.1 + 1)

theorem familyStageModelCodesList_happ_arg_comp : Computable familyStageModelCodesList_happ_arg :=
