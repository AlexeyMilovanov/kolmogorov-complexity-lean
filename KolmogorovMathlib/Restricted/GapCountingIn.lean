...
theorem familyCandidateCodes_computable (c : Code) (𝒜 : PreDescriptionFamily) :
  ...
  convert h_filter.comp ( Computable.pair ( ( candidateCodes_primrec c ).to_comp )
      ( 𝒜.enumeration.computable.comp ( Computable.snd ) ) ) using 1
