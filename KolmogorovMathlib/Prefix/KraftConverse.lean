...
-/
-- Heartbeat floor: this explicit Kraft construction still exceeds the default
-- 200k budget while sorting lengths and discharging prefix-freeness arithmetic.
