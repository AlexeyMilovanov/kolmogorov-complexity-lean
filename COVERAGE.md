...
| Primrec toolkit | `Foundation/PrimrecExtras.lean` | `Primrec.list_drop_listFirst`, `Primrec.list_take_listFirst`, `Primrec.list_takeWhile` (Mathlib), `Primrec.list_replicate`, `Primrec.nat_iterate'`, `primrec_auto` — add new general `Primrec` lemmas HERE |
